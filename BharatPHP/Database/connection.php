...
namespace BharatPHP\Database;

use PDO, PDOStatement, BharatPHP\Config, BharatPHP\Event;
...
class Connection
{
	...
	protected function grammar()
	{
		...
		if (isset(\BharatPHP\Database::$registrar[$this->driver()])) {
			$resolver = \BharatPHP\Database::$registrar[$this->driver()]['query'];
	...
	protected function log($sql, $bindings, $start)
	{
		...
		Event::fire('BharatPHP.query', array($sql, $bindings, $time));
