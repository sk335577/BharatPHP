<?php namespace BharatPHP\Database;

use Closure;
use BharatPHP\Fluent;
use BharatPHP\Database as DB;
...
class Schema {
	...
	public static function grammar(Connection $connection)
	{
		...
		if (isset(\BharatPHP\Database::$registrar[$driver]))
		{
			return \BharatPHP\Database::$registrar[$driver]['schema']();
		}
