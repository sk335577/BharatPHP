...
class Memcached extends Driver {
	 ...
	 *
	 * @var BharatPHP\Cache\Drivers\Memcached
	 */
	private $memcached;
	 ...
	 *
	 * @param  BharatPHP\Cache\Drivers\Memcached  $memcached
	 * @return void
	 */
	public function __construct(\BharatPHP\Cache\Drivers\Memcached $memcached)
	{
